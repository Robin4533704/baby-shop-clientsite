...
import ProductsPagination from './ProductsPagination'; // Make sure this import exists
...
const Products = () => {
  ...
  // Memoized product count display
  const productCountText = useMemo(() => {
    if (!pagination) return '';
    const start = ((filters.page - 1) * filters.limit) + 1;
    const end = Math.min(filters.page * filters.limit, pagination.totalProducts || 0);
   console.log("helo", end)
    return `Showing ${start} - ${end} of ${pagination.totalProducts || 0} products`;
  }, []);
  ...
  return (
    <div className="min-h-screen pt-[65px] bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <PageHeader
          title="Baby Products"
          description="Discover the best products for your little one"
        />
